...
> 本笔记整合了四个 C++ 实战项目，难度递进，综合运用了面向过程、面向对象（封装/继承/多态）、泛型编程和 STL 技术，帮助学习者将理论知识转化为实践能力。

---

## 项目一：通讯录管理系统

> 难度：入门 | 技术点：结构体、数组、函数、流程控制
...
> 难度：高级 | 技术点：STL容器(vector/map/deque)、算法、文件操作
...
> 难度：综合 | 技术点：多态继承体系、文件读写、STL容器、登录验证
